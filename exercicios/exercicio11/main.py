...
class LimitePrincipal():
    def __init__(self, root, controle):
        ...
        self.estudanteMenu.add_command(
            label="Insere", command=self.controle.insereEstudantes)
        self.estudanteMenu.add_command(
            label="Mostra", command=self.controle.mostraEstudantes)
        self.estudanteMenu.add_command(
        ...
        self.discipMenu.add_command(
            label="Insere", command=self.controle.insereDisciplinas)
        self.discipMenu.add_command(
            label="Mostra", command=self.controle.mostraDisciplinas)
        self.discipMenu.add_command(
            label="Consulta", command=self.controle.consultaDisciplinas)
        self.menubar.add_cascade(label="Disciplina", menu=self.discipMenu)

        self.turmaMenu.add_command(
            label="Insere", command=self.controle.insereTurmas)
        self.turmaMenu.add_command(
            label="Mostra", command=self.controle.mostraTurmas)
        self.turmaMenu.add_command(
            label="Consulta", command=self.controle.consultaTurmas)
